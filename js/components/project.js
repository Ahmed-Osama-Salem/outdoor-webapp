class Projecs extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
  <main class="bg-brown-500">
      <section
        id="what_we_do"
        class="bg-brown-500 h-auto max-w-[1920px] mx-auto"
      >
        <div
          class="lg:w-full py-20 lg:py-36 flex flex-col md:flex-row items-start justify-end"
        >
          <div class="w-[90%] ml-[4%] lg:ml-[8%] md:w-[44%] ">
            <div
              data-aos="fade-up"
              data-aos-delay="85"
            ...
            >
              <div class="border-b mt-[42px] mb-[20px] border-[#2b2624]">
                <button
                ...
                >
                  <p class="py-4 font-extralight mb-5 font-Montserrat">
              ...
              <div class="border-b border-[#2b2624]">
                ...
                >
                  <p class="py-4 lg:text-[20px] font-Montserrat">
                    We follow a consistent process that creates reliable
                    results. We take the guesswork out of contracting by setting
                    realistic expectations and charting a step-by-step roadmap
              ...
              <div class="border-b border-[#2b2624]">
                ...
                >
                  <p class="py-4 lg:text-[20px] font-Montserrat">
                    Our design process involves you in the creative journey.
                    Educating you on your options and allowing you to discover
                    your particular style, preferences, and vision for the
                    project.
                  </p>
                </div>
              </div>
              <div class="border-b border-[#2b2624]">
                ...
                >
                  <p class="py-4 lg:text-[20px] font-Montserrat">
                    Outdoor Dreams has partnered with HFS Home Improvement
                    Financing to help you achieve the backyard of your dreams!
                    HFS provides Outdoor Dreams clients with personal/unsecured
                    loans up to $500,000. Loans are offered up to 120% of the
                    project cost to help pay for unforeseen change orders and
              ...
              <div class="border-b border-[#2b2624]">
                ...
                >
                  <p class="py-4 lg:text-[20px] font-Montserrat">
                    ...
                    engineering, ensuring each space remains beautiful and
                    valuable as long as you are in your home.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div
            ...
            data-aos-duration="600"
            data-aos-easing="ease-in-out"
            class="mt-12 hidden md:block bg-black ml-[8%] lg:mt-0"
          >
            <img
        ...
        <div
          class="relative flex flex-col md:flex-row w-full pt-[60px] md:px-0 px-5"
        >
