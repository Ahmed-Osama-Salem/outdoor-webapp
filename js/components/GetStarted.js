class GetStarted extends HTMLElement {
    connectedCallback() {
      this.innerHTML = `
         <section
      class="   w-screen mx-auto flex items-start lg:max-h-[1080px] max-w-[1920px]"
    >
      <div
      ...
      >
        ...
        <div class=" md:w-1/2 flex items-center justify-center">
          <div class=" lg:gap-8 lg:w-2/3">
            <h3
              class="text-primary-500 mb-[30px] font-Montserrat font-bold uppercase text-sm tracking-widest"
            >
              GET STARTED
            </h3>
            <p
              class="leading-[0.8] mb-[50px] 2xl:text-7xl text-3xl md:text-[40px] lg:text-[52px] lg:leading-[0.8] lg:font-light font-Neruda 2xl:font-light text-secondary-500"
            >
